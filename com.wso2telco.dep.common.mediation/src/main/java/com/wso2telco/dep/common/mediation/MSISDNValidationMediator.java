	...
	public boolean mediate(MessageContext messageContext) {
		...
		try {
			...
			if (matcher.find()) {
				...
				messageContext.setProperty("messageId", "SVC0004");
				messageContext.setProperty("errorText", errorText);
				messageContext.setProperty("errorVariable", errorVariable + " " + msisdn);
				messageContext.setProperty("httpStatusCode", "400");
				messageContext.setProperty("exceptionType", "SERVICE_EXCEPTION");
			}
		} catch (Exception e) {
